...
```{r}
congressman_ids[ !(congressman_ids %in% congressman_ids_merge)]
```
...
```{r}
library(ggplot2)
ggplot(figure_A_results, aes(x = congress)) +
  ...
  scale_color_manual(values = c("Positive" = "blue", "Negative" = "red"))+ggtitle("Figure A - House") 

ggplot(figure_B_results, aes(x = congress)) +
  geom_line(aes(y = prop_pos_all, color = "Positive")) +
  geom_line(aes(y = prop_neg_all, color = "Negative")) +
  labs(x = "Congress", y = "Proportion", color = "Line") +
  scale_color_manual(values = c("Positive" = "blue", "Negative" = "red"))+ggtitle("Figure B - Senate") 
...
ggplot(figure_C_results, aes(x = congress)) +
  geom_line(aes(y = prop_pos_all, color = "Positive")) +
  geom_line(aes(y = prop_neg_all, color = "Negative")) +
  labs(x = "Congress", y = "Proportion", color = "Line") +
  scale_color_manual(values = c("Positive" = "blue", "Negative" = "red"))+ggtitle("Figure C - House") 

ggplot(figure_D_results, aes(x = congress)) +
  geom_line(aes(y = prop_pos_all, color = "Positive")) +
  geom_line(aes(y = prop_neg_all, color = "Negative")) +
  labs(x = "Congress", y = "Proportion", color = "Line") +
  scale_color_manual(values = c("Positive" = "blue", "Negative" = "red"))+ggtitle("Figure D - Senate") 
```
